package com.mishkat.PharmacyManagement.utill;
...
public class EmailService {
    ...
    public void sendVerificationEmail(String to, String name, String token) throws MessagingException {
                                    ...
                                    <tr>
                                        <td align="center"
                                            ...
                                            <p style="color:#dbeafe; margin-top:10px;">
                                                Fast & Reliable SmartPharmacy Service
                                            </p>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td style="padding:40px; color:#334155;">
                                            ...
                                            <p style="font-size:16px; line-height:1.7;">
                                                Thank you for registering with SmartPharmacy.
                                                Please verify your email address to activate your account
                                                and start using our Smart Pharmacy.
                                            </p>
        ...
        sendSimpleMail(to, "Verify your account", body);
    }
    ...
    public void sendPasswordResetEmail(String to, String name, String token) throws MessagingException {
        ...
        sendSimpleMail(to, "Reset your password", body);
    }
